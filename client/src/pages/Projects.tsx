...
// } from 'lucide-react';
// import { useLayout } from '@/contexts/LayoutContext'; // <-- ایمپورت کنید
...
//   const { setIsHeroVisible } = useLayout(); // <-- از Context استفاده کنید
//   const heroSectionEndRef = useRef<HTMLDivElement>(null); // <-- یک ref برای دیده‌بان بسازید
...
//       ([entry]) => {
//         // وقتی المان دیده‌بان در دید کاربر باشد، isIntersecting برابر true است
//         // ما به Navbar می‌گوییم که بخش Hero قابل مشاهده است
//         setIsHeroVisible(entry.isIntersecting);
//       },
//       {
//         root: null, // مشاهده نسبت به viewport
//         rootMargin: "-100px", // کمی زودتر خبر بده (به اندازه ارتفاع Navbar)
//         threshold: 0, // به محض ورود یا خروج اولین پیکسل
//       }
//     );

//     const currentRef = heroSectionEndRef.current;
//     if (currentRef) {
